...
from .models import Post, Tag, Category, Series, Comment, Pictures
...
class PostAdmin(admin.ModelAdmin):
    list_display = ('id' , 'admin_thumb','title', 'author' ,'created_at', 'updated_at' , 'is_public', 'series','_tag', 'category', 'summary')  # 一覧に出したい項目
    ...
    def _tag(self, row):#https://qiita.com/masutaro/items/502b6e92de7d99939741 manytomanyfieldの一覧表示の仕方
